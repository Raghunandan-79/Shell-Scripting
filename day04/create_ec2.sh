...
install_awscli() {
	echo "Installing AWS CLIv2 on Linux...."
...
main() {
	...
	# specify parameters for creating EC2 instance
	AMI_ID=""
	INSTANCE_TYPE="t2.micro"
	KEY_NAME=""
	SUBNET_ID=""
	SECURITY_GROUP_IDS=""
	INSTANCE_NAME="Shell-script-ec2-demo" # you can cahnge according to your needs
